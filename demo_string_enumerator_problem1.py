...
class ToyInterpreter(PostOrderInterpreter):
    ...
    def eval_tofun(self, node, args):
        return
    def eval_get_fun(self, node, args):
        return args[0]
...
def main():
    ...
    spec = S.parse_file('example/simplestring1.tyrell')
    ...
    synthesizer = Synthesizer(
        ...
        decider=ExampleConstraintDecider(
            ...
            examples=[Example(input=["ABCDE"],output="abcde")] # TBD: provide the example here
        )
    )
